...
public class CasteloSalaoPrincipal extends AppCompatActivity implements GestureDetector.OnGestureListener {

    private GestureDetector gestureDetector;
    private Vibrator v;
    Handler handler = new Handler();
    private boolean liberar = false;
    private boolean investigar = false;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_castelo_salao_principal);

        v = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
        gestureDetector = new GestureDetector(this);

        PlayerMusic.addMusic(this, R.raw.music_castle);
        PlayerNarra.addNarra(this, R.raw.narra_castle_main_room);
        PlayerMusic.play();
        PlayerNarra.play();
    ...
    public void onLongPress(MotionEvent e) {
        ...
        if(!investigar){
            v.vibrate(200);
            investigar = true;
            PlayerNarra.addNarra(this, R.raw.invest_castle_main_room);
            PlayerNarra.play();
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        ...
        if(e1.getY() - e2.getY() > 50){
            ...
            if(liberar){
               ...
               Intent i = new Intent(getApplicationContext(), CasteloSalaTrono.class);
               startActivity(i);
        ...
        if(e1.getX() - e2.getX() > 50){
            ...
            if(liberar){
                PlayerMusic.stopPlay();
                Intent i = new Intent(getApplicationContext(), CasteloQuartoRei.class);
                startActivity(i);
                overridePendingTransition(R.anim.res_anim_fadein, R.anim.res_anim_fadeout);
            }
            return true;
