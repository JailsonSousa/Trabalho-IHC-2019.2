...
public class CasteloSalaTrono extends AppCompatActivity implements GestureDetector.OnGestureListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_castelo_sala_trono);

        v = (Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
        gestureDetector = new GestureDetector(this);

        PlayerMusic.addMusic(this, R.raw.music_castle);
        PlayerNarra.addNarra(this, R.raw.narra_throne_room);
        PlayerNarra.play();
        PlayerMusic.play();
    ...
    public void onLongPress(MotionEvent e) {
        ...
        if(!investigar){
            v.vibrate(200);
            investigar = true;
            PlayerNarra.addNarra(this, R.raw.invest_throne_room);
            PlayerNarra.play();
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        ...
        if(e1.getY() - e2.getY() > 50){
            ...
            if(liberar){
                ...
                Intent i = new Intent(getApplicationContext(), CasteloSalaTesouro.class);
                startActivity(i);
